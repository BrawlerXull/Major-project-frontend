...
const faqData: FAQItem[] = [
  {
    question: "What is MediaMind and who is it for?",
    answer:
      "MediaMind is a comprehensive billing automation platform designed for businesses that need custom contract management. It's perfect for SaaS companies, service providers, and enterprises looking to streamline their billing processes.",
  },
  {
  ...
  {
    question: "Can I integrate MediaMind with my existing tools?",
    answer:
      "Yes! MediaMind integrates seamlessly with popular CRM systems, accounting software, and payment processors. We support APIs and webhooks for custom integrations with your existing workflow.",
  },
  {
  ...
  {
    question: "Is my data secure with MediaMind?",
    answer:
  ...
  {
    question: "How do I get started with MediaMind?",
    answer:
